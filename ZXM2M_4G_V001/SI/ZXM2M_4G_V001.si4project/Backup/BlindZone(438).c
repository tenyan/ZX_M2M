...
#define GBEP_BZ_SAVE_PERIOD_SP  59 // 2分钟
#define GBEP_BZ_SAVE_PERIOD_SP  19 // 20秒 测试用
...
uint16_t GbepBlindZone_BuildEngData(uint8_t* pdata)
{
  uint16_t len = 0;
...
uint16_t GbepBlindZone_BuildObdData(uint8_t* pdata)
{
  uint16_t len = 0;
