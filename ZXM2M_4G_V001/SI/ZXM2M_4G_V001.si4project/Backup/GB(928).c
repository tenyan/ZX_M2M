...
//#define GBEP_GetMainLinkState()           NetSocket_GetLinkState(&bjep_socket)
#define GBEP_DisableMainLink()            NetSocket_Disable(&bjep_socket)
#define GBEP_EnableMainLink()             NetSocket_Enable(&bjep_socket)
//#define GBEP_SendMainNetData(pData, len)  NetSocket_Send(&bjep_socket, pData, len)  // 发到北京市环保平台

//#define GBEP_GetSubLinkState()           NetSocket_GetLinkState(&gbep_socket)
#define GBEP_DisableSubLink()            NetSocket_Disable(&gbep_socket)
#define GBEP_EnableSubLink()             NetSocket_Enable(&gbep_socket)
// #define GBEP_SendSubNetData(pData, len)  NetSocket_Send(&gbep_socket, pData, len)  // 发到重型环保平台
...
#define GBEP_SendMainNetData(pData, len)  NetSocket_Send(&gbep_socket, pData, len)
#define GBEP_SendSubNetData(pData, len)  ;
