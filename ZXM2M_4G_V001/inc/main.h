...
enum
{
  ...
  PTHREAD_MAINEP_SOCKET_SERVICE_ID,
  PTHREAD_MAINEP_PROCESS_ID,
  PTHREAD_MAINEP_PRODUCE_ID,
  PTHREAD_SUBEP_SOCKET_SERVICE_ID,
  PTHREAD_SUBEP_PROCESS_ID,
  //PTHREAD_SUBEP_PRODUCE_ID,
  PTHREAD_COLLECT_ID,
  PTHREAD_AUX_COM_PROCESS_ID,
  PTHREAD_AUX_COM_PRODUCE_ID,
  NUMBER_OF_PTHREADS
};
extern pthread_t pthreads[NUMBER_OF_PTHREADS];

#define DEFAULT_THREAD_STACK_SIZE   40960  // thread堆栈设置为40KB
