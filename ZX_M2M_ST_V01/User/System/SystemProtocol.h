...
#define GSM_RESTTIME             	180 //GSM重启3次后休息时间3分钟
...
//向平台发送状态同步数据
#define SSDATA_MAX_REPEATS		2	//基本工作数据上传最大重复次数
#define SSDATA_RESPOND_TIMEOUT	8	//基本工作数据上传后等待响应超时的最长时间,单位:s
...
typedef struct _FirmwareUpdate{
	...
	uint8 ucdev;			//升级的目标设备0x00:终端,0x01:控制器,0x02:显示器,0x03:其他
	...
	uint8 ucMainCPuUpgradeFlag;         //主处理器升级标志0-未升级,1-正在升级
}stuFirmwareUpdate;
