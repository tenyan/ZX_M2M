...
enum
{
  ...
  NMEA_PACK_TYPE_TXT = 0x20, /// GPTXT天线状态信息
};
...
enum
{
  ANTENNA_STATUS_NONE = 0x00, // 天线状态未知
  ANTENNA_STATUS_OK = 0x01,  // 天线正常
  ANTENNA_STATUS_OPEN = 0x02, // 天线开路
  ANTENNA_STATUS_SHORT = 0x03 // 天线短路
};
