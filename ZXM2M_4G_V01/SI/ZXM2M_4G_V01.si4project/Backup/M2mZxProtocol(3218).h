...
#define ZXINFO_A5FF_POS7_ADDR    (ZXINFO_A5FF_POS6_ADDR+1)  // 工作模式
#define ZXINFO_A5FF_POS8_ADDR    (ZXINFO_A5FF_POS7_ADDR+1)  // ST固件版本信息
#define SIZE_OF_ZXINFO_A5FF      (ZXINFO_A5FF_POS8_ADDR+2)  // 总字节数(11B)
