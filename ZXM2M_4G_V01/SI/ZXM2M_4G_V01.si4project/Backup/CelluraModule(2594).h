...
//-----头文件调用-------------------------------------------------------------
#include "types.h"
#include "CelluraCore.h"


#define CELLURA_MAX_CONNS                6
#define CELLURA_CFG_CONN_MAX_DATA_LEN    1460
#define CELLURA_CFG_MAX_SEND_RETRIES     3
#define CELLURA_CFG_AT_PORT_BAUDRATE     115200
#define CELLURA_CFG_IPD_MAX_BUFF_SIZE    1460
#define CELLURA_CFG_RCV_BUFF_SIZE       0x400
