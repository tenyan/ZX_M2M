...
typedef struct
{
  ...
  uint8_t can1_recv_state;  // 接收状态:0=未收到数据, 1=已收到数据
  uint8_t can2_recv_state;  // 接收状态:0=未收到数据, 1=已收到数据
  uint8_t can1_comm_state;  // 通信状态:0=异常, 1=正常
  uint8_t can2_comm_state;  // 通信状态:0=异常, 1=正常
}colt_info_t;
