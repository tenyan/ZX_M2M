...
#define hjep_send_buffer              net_public_data_buffer
#define HJEP_SendNetData(pData, len)  net_socket_send(&hjep_socket, pData, len)
#define HJEP_GetLinkState()           net_socket_GetLinkState(&hjep_socket)

#define HJEP_SEND_DATA_TIME_SP        100   //发送周期10秒
#define HJEP_SEND_HB_TIME_SP          1800  //发送周期3分钟
#define HJEP_SEND_BZ_DATA_TIME_SP     20    //发送周期2秒
...
{
  hjep_socket.conId = SOCKET_LINK_HJ;
