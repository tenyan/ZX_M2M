...
//#define HJEP_ENG_CHK_ADDRESS   (HJEP_ADD_POS7_ADDRESS+2) // 校验码
...
//#define HJEP_OBD_CHK_ADDRESS      (HJEP_ADD_POS7_ADDRESS+2) // 校验码
//#define NUMBER_OF_HJEP_OBD_POS  (HJEP_OBD_POS10_ADDRESS+1)
...
#define HJEP_PACKET_CMD_BLIND_ZONE_DATA  0x03 // 补发信息上报
...
//#define MAX_DTC_TABLE_SIZE    20  // 故障码最大数量
//#define DTC_DEBOUNCE_TIME_SP  30 // 故障码去耦时间
//#define ENG_DTC_BUFFER_SIZE   (MAX_DTC_TABLE_SIZE*4)
