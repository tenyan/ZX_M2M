 ...
 ******************************************************************************/
// 上车作业TLV--机械/液控
uint16_t zxup_jxyk_tlv_tb[] = {0xA5A0, 0xA5C8};
#define NUM_OF_ZXUP_JXYK_TLV  (sizeof(zxup_jxyk_tlv_tb)/sizeof(zxup_jxyk_tlv_tb[0]))

// 上车作业TLV--电控绳排
uint16_t zxup_dksp_tlv_tb[] = {
  0xA5A0, 0xA5A3, 0xA5C8, 0xA5A6, 0xA5A7, 0xA5A9, 0xA5AB, 0xA5AC,
  0xA5AD, 0xA5AE, 0xA5AF, 0xA5B0, 0xA5B3, 0xA5B4, 0xA5B5, 0xA5BF,
  0xA5C0, 0xA5C1 };
#define NUM_OF_ZXUP_DKSP_TLV  (sizeof(zxup_dksp_tlv_tb)/sizeof(zxup_dksp_tlv_tb[0]))

// 上车作业TLV--开式单缸
uint16_t zxup_ksdg_tlv_tb[] = {
  0xA5A0, 0xA5A3, 0xA5C8, 0xA5A6, 0xA5A7, 0xA5A9, 0xA5AB, 0xA5AC,
  ...
  0xA5BE,0xA5AA };
#define NUM_OF_ZXUP_KSDG_TLV  (sizeof(zxup_ksdg_tlv_tb)/sizeof(zxup_ksdg_tlv_tb[0]))

// 上车作业TLV--闭式单缸
uint16_t zxup_bsdg_tlv_tb[] = {
...
#define NUM_OF_ZXUP_BSDG_TLV  (sizeof(zxup_bsdg_tlv_tb)/sizeof(zxup_bsdg_tlv_tb[0]))

// 下车作业TLV--全地面底盘
uint16_t zxdown_ag_tlv_tb[] = {
...
#define NUM_OF_ZXDOWN_AG_TLV  (sizeof(zxdown_ag_tlv_tb)/sizeof(zxdown_ag_tlv_tb[0]))

// 下车作业TLV--汽车底盘
uint16_t zxdown_ac_tlv_tb[] = {
  0xA5EF, 0xA5F0, 0xA5F1, 0xA5F2, 0xA5E0, 0xA5E1, 0xA5E5, 0xA5E6,
  0xA5E7, 0xA5E9, 0xA5EB, 0xA502 };
#define NUM_OF_ZXDOWN_AC_TLV  (sizeof(zxdown_ac_tlv_tb)/sizeof(zxdown_ac_tlv_tb[0]))
...
//==TLV-0x100F 协处理器版本===================================================
static uint16_t im2m_BuildTlvMsg_100F(uint8_t *pbuf)
{
  uint16_t len =0;
  uint16_t st_version;
