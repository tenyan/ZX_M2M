...
//#endif
    ...
    retVal = 1;
    //pValue[MOMI_E001_POS1];  // 网络工作状态
    //pValue[MOMI_E001_POS2];  // GPS定位状态
    //pValue[MOMI_E001_POS3];  // WIFI工作状态
    //pValue[MOMI_E001_POS4];  // ETH工作状态
    //pValue[MOMI_E001_POS5];  // 远程升级标志
    //pValue[MOMI_E001_POS6];  // GPS时间
  }
