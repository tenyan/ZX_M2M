...
#define zxengine_buffer_a502    (zxengine_buffer+SIZE_OF_ZXENGINE_A502)  // 起始地址定义
...
#define tlv_3004_valid_flag    zxinfo_tlv_flag.w.bit2  //==TAG-3004外部电源电压
#define tlv_3005_valid_flag    zxinfo_tlv_flag.w.bit3  //==TAG-3005终端内置电池电压
