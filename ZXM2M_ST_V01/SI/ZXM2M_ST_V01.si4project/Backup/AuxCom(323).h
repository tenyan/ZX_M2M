...
typedef enum
{
  ...
  FCLIT_STATE_DOWNLOAD_REQ, /// 发送下载请求
  FCLIT_STATE_DOWNLOAD_RSP, /// 等待下载响应
  FCLIT_STATE_REPORT_REQ,   /// 发送结果请求
  FCLIT_STATE_REPORT_RSP,   /// 等待结果响应
  FCLIT_STATE_ERROR,        /// 升级失败
  FCLIT_STATE_SUCESS,       /// 升级成功
  FCLIT_STATE_REPORT,       /// 上报升级结果
}fclit_state_t;
