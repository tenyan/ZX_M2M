...
void iMomi_BuildAdSwitch(void)
{
  ...
  zxinfo_buffer_a5ff[ZXINFO_A5FF_POS8_ADDR] = st_time.year;  // RTC时间
  zxinfo_buffer_a5ff[ZXINFO_A5FF_POS8_ADDR+1] = st_time.month;
  zxinfo_buffer_a5ff[ZXINFO_A5FF_POS8_ADDR+2] = st_time.day;
  zxinfo_buffer_a5ff[ZXINFO_A5FF_POS8_ADDR+3] = st_time.hour;
  zxinfo_buffer_a5ff[ZXINFO_A5FF_POS8_ADDR+4] = st_time.minute;
  zxinfo_buffer_a5ff[ZXINFO_A5FF_POS8_ADDR+5] = st_time.second;
...
//#endif
    ...
    {
      rtc_time.year = pValue[MOMI_E001_POS6];  // GPS时间
      rtc_time.month = pValue[MOMI_E001_POS6+1];
      rtc_time.day = pValue[MOMI_E001_POS6+2];
      rtc_time.hour = pValue[MOMI_E001_POS6+3];
      rtc_time.minute = pValue[MOMI_E001_POS6+4];
      rtc_time.second = pValue[MOMI_E001_POS6+5];
