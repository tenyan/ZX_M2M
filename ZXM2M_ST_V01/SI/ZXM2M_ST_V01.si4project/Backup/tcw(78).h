...
#define ZXINFO_A5FF_POS6_ADDR    (ZXINFO_A5FF_POS5_ADDR+1)  // 开关量采集4
#define ZXINFO_A5FF_POS7_ADDR    (ZXINFO_A5FF_POS6_ADDR+1)  // 工作模式
#define ZXINFO_A5FF_POS8_ADDR    (ZXINFO_A5FF_POS7_ADDR+1)  // 保留字节1
#define ZXINFO_A5FF_POS9_ADDR    (ZXINFO_A5FF_POS8_ADDR+1)  // 保留字节2
#define SIZE_OF_ZXINFO_A5FF      (ZXINFO_A5FF_POS9_ADDR+1)  // 总字节数(11B)
