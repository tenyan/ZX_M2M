...
#define GPS_ANT_SHORT_IN_PIN        GPIO_Pin_1
#define GPS_ANT_SHORT_IN()            (GPS_ANT_SHORT_IN_PORT->IDR & defineGPS_ANT_SHORT_IN_PIN)
...
#define EMMC_POWER_PORT        GPIOC
#define EMMC_POWER_PIN         GPIO_Pin_4
#define EMMC_POWER_ON()        EMMC_POWER_PORT->BSRRL = EMMC_POWER_PIN // 高电平开电
#define EMMC_POWER_OFF()       EMMC_POWER_PORT->BSRRH = EMMC_POWER_PIN // 低电平关电
