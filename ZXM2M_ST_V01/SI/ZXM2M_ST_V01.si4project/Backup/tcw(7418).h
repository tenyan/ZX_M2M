 ...
 * 作业时间和频次统计
 ******************************************************************************/
 #define ZXSTS_STEP_SP   180  // 梯级:3分钟
 #define ZXSTS_DEBOUNCE_TIME_SP  3 // 3秒
 
// 频次统计类型
enum
{
  ZXSTS_TYPE_POWER = 0,  // 二节伸
  ZXSTS_TYPE_POWER,  // 二节缩
  ZXSTS_TYPE_POWER,  // 多节伸
  ZXSTS_TYPE_POWER,  // 多节缩
  ...
  ZXSTS_TYPE_LMI,  // 超载
  ZXSTS_TYPE_ZJSQ,  // 主卷三圈
  ZXSTS_TYPE_FJSQ,  // 副卷三圈
  ZXSTS_TYPE_ZBGX,  // 主臂高限
  ZXSTS_TYPE_FBGX,  // 副臂高限(备用)
  ZXSTS_TYPE_ZQZ,  // 总强制
  ZXSTS_TYPE_CZKG,  // 拆装开关
  ZXSTS_TYPE_BFQQZ,  // 变幅起强制
  ZXSTS_TYPE_GXQZ,  // 高限强制
  ZXSTS_TYPE_SQQZ,  // 三圈强制
