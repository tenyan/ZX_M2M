...
uint8_t CAN_ProcessRecvUpMsg(uint32_t canId, uint8_t *pdata, uint8_t size)
{
  ...
  case 0x561:
    ...
    zxup_buffer_a5a7[ZXUP_A5A7_POS1+2] = pdata[3];
  ...
  case 0x1B2:
    ...
    break;
  case 0x1B3:
    zxup_buffer_a5a9[ZXUP_A5A9_POS2] = pdata[0]; // 面板3
    zxup_buffer_a5a9[ZXUP_A5A9_POS2+1] = pdata[1];
    tlv_a5a9_valid_flag = 1;
    retval = 0x01;
    break;
  ...
  case 0x1E9:
    ...
    zxup_buffer_a5b9[ZXUP_A5B9_POS1] = pdata[6]; // 蓄能器压力
    zxup_buffer_a5b9[ZXUP_A5B9_POS1+1] = pdata[7];
    tlv_a5b8_valid_flag = 1;
    tlv_a5b9_valid_flag = 1;
    retval = 0x01;
    break;
  ...
  //==上车系统版本====================================================================================
  case 0x562:
    zxversion_buffer_a505[ZXVERSION_A505_POS6] = pdata[0];  // 显示器2底层
    zxversion_buffer_a505[ZXVERSION_A505_POS6+1] = pdata[1];
    zxversion_buffer_a505[ZXVERSION_A505_POS6+2] = pdata[2];
    tlv_a505_valid_flag = 1;
    retval = 0x01;
    break;
  ...
  case 0x573:
    zxversion_buffer_a505[ZXVERSION_A505_POS4] = pdata[4];  // 控制器
    zxversion_buffer_a505[ZXVERSION_A505_POS4+1] = pdata[5];
    zxversion_buffer_a505[ZXVERSION_A505_POS4+2] = pdata[6];
    tlv_a505_valid_flag = 1;
    retval = 0x00;
    break;
...
uint8_t CAN_ProcessRecvDownMsg_AC(uint32_t canId, uint8_t *pdata, uint8_t size)
{
  ...
  case 0x1CF25E21:
    ...
    zxdown_buffer_a5e5[ZXDOWN_A5E5_POS5] = pdata[0];  // 缓速器油温
    zxdown_buffer_a5e5[ZXDOWN_A5E5_POS5+1] = pdata[1];
    zxdown_buffer_a5e5[ZXDOWN_A5E5_POS6] = pdata[2];  // 缓速力矩百分比
...
uint8_t CAN_ProcessRecvEngineMsg_AC(uint32_t canId, uint8_t *pdata, uint8_t size)
{
  ...
  case 0x18FD9BA3:
    ...
    break;
  case 0x18FCBD3D:
    zxengine_buffer_a5f1[ZXENGINE_A5F1_POS6] = pdata[4]; // 累计尿素消耗量
    zxengine_buffer_a5f1[ZXENGINE_A5F1_POS6+1] = pdata[5];
    zxengine_buffer_a5f1[ZXENGINE_A5F1_POS6+2] = pdata[6];
    zxengine_buffer_a5f1[ZXENGINE_A5F1_POS6+3] = pdata[7];
    tlv_a5f1_valid_flag = 1;
    retval = 0x01;
    break;
  case 0x18FE56A3:
...
uint8_t CAN_ProcessRecvEngineMsg_AG(uint32_t canId, uint8_t *pdata, uint8_t size)
{
  ...
  case 0x41B:
    ...
    zxengine_buffer_a5f1[ZXENGINE_A5F1_POS3] = pdata[6]; // 尿素泵压力
    zxengine_buffer_a5f1[ZXENGINE_A5F1_POS3+1] = pdata[7];
    zxengine_buffer_a5f1[ZXENGINE_A5F1_POS6] = pdata[1]; // 累计尿素消耗量
    zxengine_buffer_a5f1[ZXENGINE_A5F1_POS6+1] = pdata[2];
    zxengine_buffer_a5f1[ZXENGINE_A5F1_POS6+2] = pdata[3];
    zxengine_buffer_a5f1[ZXENGINE_A5F1_POS6+3] = pdata[4];
    tlv_a5f1_valid_flag = 1;
    retval = 0x01;
    break;
  case 0x40A:
