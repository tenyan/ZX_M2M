...
//==TAG-A5A1超起工况信息==========================================================
#define zxup_buffer_a5a1       (zxup_buffer+SIZE_OF_ZXUP_A5A0) // 起始地址定义
#define ZXUP_A5A1_POS1_ADDR    SIZE_OF_ZXUP_A5A0            // 左超起卷扬角度
...
//==TAG-A5A2塔臂工况信息==========================================================
#define zxup_buffer_a5a2       (zxup_buffer+SIZE_OF_ZXUP_A5A1)// 起始地址定义
#define ZXUP_A5A2_POS1_ADDR    SIZE_OF_ZXUP_A5A1            // 塔臂拉力左
...
//==TAG-A5A5上车发动机信息========================================================
#define zxup_buffer_a5a5       (zxup_buffer+SIZE_OF_ZXUP_A5A2)// 起始地址定义
#define ZXUP_A5A5_POS1_ADDR    SIZE_OF_ZXUP_A5A2            // 发动机转速
...
//==TAG-A5A6手柄信息==============================================================
#define zxup_buffer_a5a6       (zxup_buffer+SIZE_OF_ZXUP_A5A5)// 起始地址定义
#define ZXUP_A5A6_POS1_ADDR    SIZE_OF_ZXUP_A5A5            // 左手柄状态位
...
//==TAG-A5A7显示器1信息===========================================================
#define zxup_buffer_a5a7       (zxup_buffer+SIZE_OF_ZXUP_A5A6)// 起始地址定义
#define ZXUP_A5A7_POS1_ADDR    SIZE_OF_ZXUP_A5A6            // 产品配置
...
//==TAG-A5A8显示器2信息===========================================================
#define zxup_buffer_a5a8       (zxup_buffer+SIZE_OF_ZXUP_A5A7)// 起始地址定义
#define ZXUP_A5A8_POS1_ADDR    SIZE_OF_ZXUP_A5A7            // 超起操控
#define ZXUP_A5A8_POS2_ADDR    (ZXUP_A5A8_POS1_ADDR+8)  // 超起维修
#define SIZE_OF_ZXUP_A5A8      (ZXUP_A5A8_POS2_ADDR+2)  // 总字节数(10B)

//==TAG-A5A9总线面板信息==========================================================
#define zxup_buffer_a5a9       (zxup_buffer+SIZE_OF_ZXUP_A5A8)// 起始地址定义
#define ZXUP_A5A9_POS1_ADDR    SIZE_OF_ZXUP_A5A8            // 面板1
...
//==TAG-A5AA无线操控信息==========================================================
#define zxup_buffer_a5aa       (zxup_buffer+SIZE_OF_ZXUP_A5A9)// 起始地址定义
#define ZXUP_A5AA_POS1_ADDR    SIZE_OF_ZXUP_A5A9            // Msg1
...
//==TAG-A5AB网络拓扑信息==========================================================
#define zxup_buffer_a5ab       (zxup_buffer+SIZE_OF_ZXUP_A5AA)// 起始地址定义
#define ZXUP_A5AB_POS1_ADDR    SIZE_OF_ZXUP_A5AA          // 节点状态
#define SIZE_OF_ZXUP_A5AB      (ZXUP_A5AB_POS1_ADDR+8)  // 总字节数(8B)

//==TAG-A5AC伸缩逻辑信息==========================================================
#define zxup_buffer_a5ac       (zxup_buffer+SIZE_OF_ZXUP_A5AB)// 起始地址定义
#define ZXUP_A5AC_POS1_ADDR    SIZE_OF_ZXUP_A5AB          // 伸缩限制和解除
#define SIZE_OF_ZXUP_A5AC      (ZXUP_A5AC_POS1_ADDR+6)  // 总字节数(6B)

//==TAG-A5AD变幅逻辑信息==========================================================
#define zxup_buffer_a5ad       (zxup_buffer+SIZE_OF_ZXUP_A5AC)// 起始地址定义
#define ZXUP_A5AD_POS1_ADDR    SIZE_OF_ZXUP_A5AC          // 起落限制和解除
#define SIZE_OF_ZXUP_A5AD      (ZXUP_A5AD_POS1_ADDR+8)  // 总字节数(8B)

//==TAG-A5AE回转逻辑信息==========================================================
#define zxup_buffer_a5ae       (zxup_buffer+SIZE_OF_ZXUP_A5AD)// 起始地址定义
#define ZXUP_A5AE_POS1_ADDR    SIZE_OF_ZXUP_A5AD            // 左回限制1
...
//==TAG-A5AF主卷扬逻辑信息========================================================
#define zxup_buffer_a5af       (zxup_buffer+SIZE_OF_ZXUP_A5AE)// 起始地址定义
#define ZXUP_A5AF_POS1_ADDR    SIZE_OF_ZXUP_A5AE          // 主卷扬起落限制和解除
#define SIZE_OF_ZXUP_A5AF      (ZXUP_A5AF_POS1_ADDR+5)  // 总字节数(5B)

//==TAG-A5B0副卷扬逻辑信息========================================================
#define zxup_buffer_a5b0       (zxup_buffer+SIZE_OF_ZXUP_A5AF)// 起始地址定义
#define ZXUP_A5B0_POS1_ADDR  SIZE_OF_ZXUP_A5AF            // 副卷扬起落限制和解除
#define SIZE_OF_ZXUP_A5B0      (ZXUP_A5B0_POS1_ADDR+4)  // 总字节数(4B)

//==TAG-A5B1超起逻辑信息==========================================================
#define zxup_buffer_a5b1       (zxup_buffer+SIZE_OF_ZXUP_A5B0)// 起始地址定义
#define ZXUP_A5B1_POS1_ADDR    SIZE_OF_ZXUP_A5B0             // 超起目标展开角度
...
//==TAG-A5B2塔臂逻辑信息==========================================================
#define zxup_buffer_a5b2       (zxup_buffer+SIZE_OF_ZXUP_A5B1)// 起始地址定义
#define ZXUP_A5B2_POS1_ADDR    SIZE_OF_ZXUP_A5B1                        // 塔卷起限制
...
//==TAG-A5B3液压油温度============================================================
#define zxup_buffer_a5b3       (zxup_buffer+SIZE_OF_ZXUP_A5B2)// 起始地址定义
#define ZXUP_A5B3_POS1_ADDR    SIZE_OF_ZXUP_A5B2                        // 液压油温度
...
//==TAG-A5B4主泵信息==============================================================
#define zxup_buffer_a5b4       (zxup_buffer+SIZE_OF_ZXUP_A5B3)// 起始地址定义
#define ZXUP_A5B4_POS1_ADDR    SIZE_OF_ZXUP_A5B3                        // 1#主泵电磁阀
...
#define zxup_buffer_a5b5       (zxup_buffer+SIZE_OF_ZXUP_A5B4)// 起始地址定义
#define ZXUP_A5B5_POS1_ADDR    SIZE_OF_ZXUP_A5B4                        // 伸电磁阀
...
//==TAG-A5B6主阀3 大吨位==========================================================
#define zxup_buffer_a5b6       (zxup_buffer+SIZE_OF_ZXUP_A5B5)// 起始地址定义
#define ZXUP_A5B6_POS1_ADDR    SIZE_OF_ZXUP_A5B5                        // 状态位
#define SIZE_OF_ZXUP_A5B6      (ZXUP_A5B6_POS1_ADDR+1)  // 总字节数(1B)

//==TAG-A5B7主泵信息==============================================================
#define zxup_buffer_a5b7       (zxup_buffer+SIZE_OF_ZXUP_A5B6)// 起始地址定义
#define ZXUP_A5B7_POS1_ADDR    SIZE_OF_ZXUP_A5B6                        // 伸缩缸压力
...
//==TAG-A5B8塔臂逻辑信息==========================================================
#define zxup_buffer_a5b8       (zxup_buffer+SIZE_OF_ZXUP_A5B7)// 起始地址定义
#define ZXUP_A5B8_POS1_ADDR    SIZE_OF_ZXUP_A5B7                        // 销锁死和解锁状态位
...
//==TAG-A5B9缸臂销控制阀==========================================================
#define zxup_buffer_a5b9       (zxup_buffer+SIZE_OF_ZXUP_A5B8)// 起始地址定义
#define ZXUP_A5B9_POS1_ADDR    SIZE_OF_ZXUP_A5B8                        // 状态字节
#define ZXUP_A5B9_POS2_ADDR    (ZXUP_A5B9_POS1_ADDR+1)  // 蓄能器压力
#define SIZE_OF_ZXUP_A5B9      (ZXUP_A5B9_POS2_ADDR+2)  // 总字节数(3B)

//==TAG-A5BA变幅平衡阀============================================================
#define zxup_buffer_a5ba       (zxup_buffer+SIZE_OF_ZXUP_A5B9)// 起始地址定义
#define ZXUP_A5BA_POS1_ADDR    SIZE_OF_ZXUP_A5B9                        // 左变幅平衡阀电流
#define ZXUP_A5BA_POS2_ADDR    (ZXUP_A5BA_POS1_ADDR+2)  // 右变幅平衡阀电流
#define SIZE_OF_ZXUP_A5BA      (ZXUP_A5BA_POS2_ADDR+2)  // 总字节数(4B)

//==TAG-A5BB主卷泵================================================================
#define zxup_buffer_a5bb       (zxup_buffer+SIZE_OF_ZXUP_A5BA)// 起始地址定义
#define ZXUP_A5BB_POS1_ADDR    SIZE_OF_ZXUP_A5BA                        // 起升电磁阀
...
//==TAG-A5BC主卷马达==============================================================
#define zxup_buffer_a5bc       (zxup_buffer+SIZE_OF_ZXUP_A5BB)// 起始地址定义
#define ZXUP_A5BC_POS1_ADDR    SIZE_OF_ZXUP_A5BB                        // 马达电流
...
//==TAG-A5BD塔卷泵================================================================
#define zxup_buffer_a5bd       (zxup_buffer+SIZE_OF_ZXUP_A5BC)// 起始地址定义
#define ZXUP_A5BD_POS1_ADDR    SIZE_OF_ZXUP_A5BC                        // 起升电磁阀
...
//==TAG-A5BE塔卷马达==============================================================
#define zxup_buffer_a5be       (zxup_buffer+SIZE_OF_ZXUP_A5BD)// 起始地址定义
#define ZXUP_A5BE_POS1_ADDR    SIZE_OF_ZXUP_A5BD                        // 马达电流
...
//==TAG-A5BF回转泵================================================================
#define zxup_buffer_a5bf       (zxup_buffer+SIZE_OF_ZXUP_A5BE)// 起始地址定义
#define ZXUP_A5BF_POS1_ADDR    SIZE_OF_ZXUP_A5BE                        // 左回转电磁阀
...
//==TAG-A5C0回转制动阀============================================================
#define zxup_buffer_a5c0       (zxup_buffer+SIZE_OF_ZXUP_A5BF)// 起始地址定义
#define ZXUP_A5C0_POS1_ADDR    SIZE_OF_ZXUP_A5BF                        // 字节状态位
#define ZXUP_A5C0_POS2_ADDR    (ZXUP_A5C0_POS1_ADDR+1)  // 卷筒转速
#define SIZE_OF_ZXUP_A5C0      (ZXUP_A5C0_POS2_ADDR+2)  // 总字节数(3B)

//==TAG-A5C1辅助阀1===============================================================
#define zxup_buffer_a5c1       (zxup_buffer+SIZE_OF_ZXUP_A5C0)// 起始地址定义
#define ZXUP_A5C1_POS1_ADDR    SIZE_OF_ZXUP_A5C0                        // 字节状态位1
#define ZXUP_A5C1_POS2_ADDR    (ZXUP_A5C1_POS1_ADDR+1)  // 字节状态位2
#define SIZE_OF_ZXUP_A5C1      (ZXUP_A5C1_POS2_ADDR+1)  // 总字节数(2B)

//==TAG-A5C2辅助阀2(超大吨位)=====================================================
#define zxup_buffer_a5c2       (zxup_buffer+SIZE_OF_ZXUP_A5C1)// 起始地址定义
#define ZXUP_A5C2_POS1_ADDR    SIZE_OF_ZXUP_A5C1                        // 压力选择
#define ZXUP_A5C2_POS2_ADDR    (ZXUP_A5C2_POS1_ADDR+2)  // 字节状态位
#define SIZE_OF_ZXUP_A5C2      (ZXUP_A5C2_POS2_ADDR+1)  // 总字节数(3B)

//==TAG-A5C3左超起阀组============================================================
#define zxup_buffer_a5c3       (zxup_buffer+SIZE_OF_ZXUP_A5C2)// 起始地址定义
#define ZXUP_A5C3_POS1_ADDR    SIZE_OF_ZXUP_A5C2                        // 卷扬起
...
//==TAG-A5C4右超起阀组============================================================
#define zxup_buffer_a5c4       (zxup_buffer+SIZE_OF_ZXUP_A5C3)// 起始地址定义
#define ZXUP_A5C4_POS1_ADDR    SIZE_OF_ZXUP_A5C3                        // 卷扬起
...
//==TAG-A5C8作业油耗信息==========================================================
#define zxup_buffer_a5c8              (zxup_buffer+SIZE_OF_ZXUP_A5C4)// 起始地址定义
#define ZXUP_A5C8_POS1_ADDR    SIZE_OF_ZXUP_A5C4                        // 作业总运行时间
...
#define zxup_buffer_a5c9       (zxup_buffer+SIZE_OF_ZXUP_A5C8)// 起始地址定义
#define ZXUP_A5C9_POS1_ADDR    SIZE_OF_ZXUP_A5C8                        // 作业总运行时间
...
// 上车数据缓存大小
#define SIZE_OF_ZXUP_BUFFER    SIZE_OF_ZXUP_A5C9 //(zxup_buffer_a5c9+SIZE_OF_ZXUP_A5C9-zxup_buffer_a5a0)
...
//==TAG-A5E1传动系统==============================================================
#define zxdown_buffer_a5e1       (zxdown_buffer+SIZE_OF_ZXDOWN_A5E0) // 起始地址定义
#define ZXDOWN_A5E1_POS1_ADDR    SIZE_OF_ZXDOWN_A5E0                          // 变速箱档位
...
//==TAG-A5E2支腿相关信息==========================================================
#define zxdown_buffer_a5e2       (zxdown_buffer+SIZE_OF_ZXDOWN_A5E1)// 起始地址定义
#define ZXDOWN_A5E2_POS1_ADDR    SIZE_OF_ZXDOWN_A5E1                          // 字节状态位1
...
//==TAG-A5E3悬挂系统==============================================================
#define zxdown_buffer_a5e3       (zxdown_buffer+SIZE_OF_ZXDOWN_A5E2)// 起始地址定义
#define ZXDOWN_A5E3_POS1_ADDR    SIZE_OF_ZXDOWN_A5E2                          // 悬挂压力
...
//==TAG-A5E4转向系统（全地面）====================================================
#define zxdown_buffer_a5e4       (zxdown_buffer+SIZE_OF_ZXDOWN_A5E3)// 起始地址定义
#define ZXDOWN_A5E4_POS1_ADDR    SIZE_OF_ZXDOWN_A5E3                          // 一二轴转向角度
...
//==TAG-A5E5转向系统（汽车）======================================================
#define zxdown_buffer_a5e5       (zxdown_buffer+SIZE_OF_ZXDOWN_A5E4)// 起始地址定义
#define ZXDOWN_A5E5_POS1_ADDR    SIZE_OF_ZXDOWN_A5E4                          // 当前一轴转角
...
//==TAG-A5E6制动系统==============================================================
#define zxdown_buffer_a5e6       (zxdown_buffer+SIZE_OF_ZXDOWN_A5E5)// 起始地址定义
#define ZXDOWN_A5E6_POS1_ADDR    SIZE_OF_ZXDOWN_A5E5                          // 回路一气压
...
//==TAG-A5E7动力系统==============================================================
#define zxdown_buffer_a5e7       (zxdown_buffer+SIZE_OF_ZXDOWN_A5E6)// 起始地址定义
#define ZXDOWN_A5E7_POS1_ADDR    SIZE_OF_ZXDOWN_A5E6                          // 字节状态位
#define SIZE_OF_ZXDOWN_A5E7      (ZXDOWN_A5E7_POS1_ADDR+1)  // 总字节数(1B)

//==TAG-A5E8单发取力系统==========================================================
#define zxdown_buffer_a5e8       (zxdown_buffer+SIZE_OF_ZXDOWN_A5E7)// 起始地址定义
#define ZXDOWN_A5E8_POS1_ADDR    SIZE_OF_ZXDOWN_A5E7                          // 字节状态位1
#define ZXDOWN_A5E8_POS2_ADDR    (ZXDOWN_A5E8_POS1_ADDR+1)  // 字节状态位2
#define SIZE_OF_ZXDOWN_A5E8      (ZXDOWN_A5E8_POS2_ADDR+1)  // 总字节数(2B)

//==TAG-A5E9液压系统==============================================================
#define zxdown_buffer_a5e9       (zxdown_buffer+SIZE_OF_ZXDOWN_A5E8)// 起始地址定义
#define ZXDOWN_A5E9_POS1_ADDR    SIZE_OF_ZXDOWN_A5E8                                       // 液压油温度
#define ZXDOWN_A5E9_POS2_ADDR    (ZXDOWN_A5E9_POS1_ADDR+1)  // 液压系统压力
#define SIZE_OF_ZXDOWN_A5E9      (ZXDOWN_A5E9_POS2_ADDR+2)  // 总字节数(3B)

//==TAG-A5EA双动力驱动系统========================================================
#define zxdown_buffer_a5ea       (zxdown_buffer+SIZE_OF_ZXDOWN_A5E9)// 起始地址定义
#define ZXDOWN_A5EA_POS1_ADDR    SIZE_OF_ZXDOWN_A5E9                          // 字节状态位1
...
//==TAG-A5EB轮胎胎压==============================================================
#define zxdown_buffer_a5eb       (zxdown_buffer+SIZE_OF_ZXDOWN_A5EA)// 起始地址定义
#define ZXDOWN_A5EB_POS1_ADDR    SIZE_OF_ZXDOWN_A5EA         // 胎压#1-18
#define SIZE_OF_ZXDOWN_A5EB      (ZXDOWN_A5EB_POS3_ADDR+18)  // 总字节数(18B)

//==TAG-A5EC左支腿面板============================================================
#define zxdown_buffer_a5ec       (zxdown_buffer+SIZE_OF_ZXDOWN_A5EB)// 起始地址定义
#define ZXDOWN_A5EC_POS1_ADDR    SIZE_OF_ZXDOWN_A5EB                          // 字节状态位1
...
//==TAG-A5ED右支腿面板============================================================
#define zxdown_buffer_a5ed       (zxdown_buffer+SIZE_OF_ZXDOWN_A5EC)// 起始地址定义
#define ZXDOWN_A5ED_POS1_ADDR    SIZE_OF_ZXDOWN_A5EC                          // 字节状态位1
...
//==TAG-A5EE中控台输入信息========================================================
#define zxdown_buffer_a5ee       (zxdown_buffer+SIZE_OF_ZXDOWN_A5ED)// 起始地址定义
#define ZXDOWN_A5EE_POS1_ADDR    SIZE_OF_ZXDOWN_A5ED                          // 字节状态位1
...
//==TAG-A5A3支腿作业信息==========================================================
#define zxdown_buffer_a5a3       (zxdown_buffer+SIZE_OF_ZXDOWN_A5EE)// 起始地址定义
#define ZXDOWN_A5A3_POS1_ADDR    SIZE_OF_ZXDOWN_A5EE                        // 水平支腿长度
...
//==TAG-A5A4辅助支腿作业信息=======================================================
#define zxdown_buffer_a5a4       (zxdown_buffer+SIZE_OF_ZXDOWN_A5A3)// 起始地址定义
#define ZXDOWN_A5A4_POS1_ADDR    SIZE_OF_ZXDOWN_A5A3                        // 辅助支腿状态
...
// 下车底盘数据缓存大小
#define SIZE_OF_ZXDOWN_BUFFER   SIZE_OF_ZXDOWN_A5A4  //(zxdown_buffer_a5a4+SIZE_OF_ZXDOWN_A5A4-zxdown_buffer_a5e0) 
...
//==TAG-A5F0行驶油耗==============================================================
#define zxengine_buffer_a5f0              (zxengine_buffer+SIZE_OF_ZXENGINE_A5EF)// 起始地址定义
#define ZXENGINE_A5F0_POS1_ADDR    SIZE_OF_ZXENGINE_A5EF                            // 行驶总运行时间
...
//==TAG-A5F1 SCR参数（国五）======================================================
#define zxengine_buffer_a5f1               (zxengine_buffer+SIZE_OF_ZXENGINE_A5F0)// 起始地址定义
#define ZXENGINE_A5F1_POS1_ADDR    SIZE_OF_ZXENGINE_A5F0                            // 尿素喷射状态
...
//==TAG-A5F2 DPF参数(国六）=======================================================
#define zxengine_buffer_a5f2              (zxengine_buffer+SIZE_OF_ZXENGINE_A5F1)// 起始地址定义
#define ZXENGINE_A5F2_POS1_ADDR    SIZE_OF_ZXENGINE_A5F1                            // DOC上游排气温度
...
#define ZXENGINE_A5F2_POS6_ADDR    (ZXENGINE_A5F2_POS5_ADDR+1)  // 字节状态位2
#define ZXENGINE_A5F2_POS7_ADDR    (ZXENGINE_A5F2_POS6_ADDR+1)  // 字节状态位3
#define ZXENGINE_A5F2_POS8_ADDR    (ZXENGINE_A5F2_POS7_ADDR+1)  // 字节状态位4
#define SIZE_OF_ZXENGINE_A5F2      (ZXENGINE_A5F2_POS8_ADDR+1)  // 总字节数(11B)

// 下车发动机数据缓存大小
#define SIZE_OF_ZXENGINE_BUFFER   SIZE_OF_ZXENGINE_A5F2 //(zxengine_buffer_a5f2+SIZE_OF_ZXENGINE_A5F2-zxengine_buffer_a5ef) 
...
#define ZXSTATISTICS_A5C5_POS1_ADDR   0  // 二节伸
#define ZXSTATISTICS_A5C5_POS2_ADDR   (ZXSTATISTICS_A5C5_POS1_ADDR+8)  // 二节缩
#define ZXSTATISTICS_A5C5_POS3_ADDR   (ZXSTATISTICS_A5C5_POS2_ADDR+8)  // 多节伸
#define ZXSTATISTICS_A5C5_POS4_ADDR   (ZXSTATISTICS_A5C5_POS3_ADDR+8)  // 多节缩
#define ZXSTATISTICS_A5C5_POS5_ADDR   (ZXSTATISTICS_A5C5_POS4_ADDR+8)  // 变幅起
#define ZXSTATISTICS_A5C5_POS6_ADDR   (ZXSTATISTICS_A5C5_POS5_ADDR+8)  // 变幅下落
#define ZXSTATISTICS_A5C5_POS7_ADDR   (ZXSTATISTICS_A5C5_POS6_ADDR+8)  // 主卷起升
#define ZXSTATISTICS_A5C5_POS8_ADDR   (ZXSTATISTICS_A5C5_POS7_ADDR+8)  // 主卷下落
#define ZXSTATISTICS_A5C5_POS9_ADDR   (ZXSTATISTICS_A5C5_POS8_ADDR+8)  // 副卷起升
#define ZXSTATISTICS_A5C5_POS10_ADDR  (ZXSTATISTICS_A5C5_POS9_ADDR+8)  // 副卷下落
#define ZXSTATISTICS_A5C5_POS11_ADDR   (ZXSTATISTICS_A5C5_POS10_ADDR+8)  // 左回转
#define ZXSTATISTICS_A5C5_POS12_ADDR   (ZXSTATISTICS_A5C5_POS11_ADDR+8)  // 右回转
...
#define ZXSTATISTICS_A5C6_POS1_ADDR   SIZE_OF_ZXSTATISTICS_A5C5  // 空缸伸
#define ZXSTATISTICS_A5C6_POS2_ADDR   (ZXSTATISTICS_A5C6_POS1_ADDR+8)  // 空缸缩
#define ZXSTATISTICS_A5C6_POS3_ADDR   (ZXSTATISTICS_A5C6_POS2_ADDR+8)  // 带臂伸
#define ZXSTATISTICS_A5C6_POS4_ADDR   (ZXSTATISTICS_A5C6_POS3_ADDR+8)  // 带臂缩
#define ZXSTATISTICS_A5C6_POS5_ADDR   (ZXSTATISTICS_A5C6_POS4_ADDR+8)  // 变幅起
#define ZXSTATISTICS_A5C6_POS6_ADDR   (ZXSTATISTICS_A5C6_POS5_ADDR+8)  // 变幅下落
#define ZXSTATISTICS_A5C6_POS7_ADDR   (ZXSTATISTICS_A5C6_POS6_ADDR+8)  // 主卷起升
#define ZXSTATISTICS_A5C6_POS8_ADDR   (ZXSTATISTICS_A5C6_POS7_ADDR+8)  // 主卷下落
#define ZXSTATISTICS_A5C6_POS9_ADDR   (ZXSTATISTICS_A5C6_POS8_ADDR+8)  // 副卷起升
#define ZXSTATISTICS_A5C6_POS10_ADDR   (ZXSTATISTICS_A5C6_POS9_ADDR+8)  // 副卷下落
#define ZXSTATISTICS_A5C6_POS11_ADDR   (ZXSTATISTICS_A5C6_POS10_ADDR+8)  // 左回转
#define ZXSTATISTICS_A5C6_POS12_ADDR   (ZXSTATISTICS_A5C6_POS11_ADDR+8)  // 右回转
...
#define ZXSTATISTICS_A5C7_POS1_ADDR   SIZE_OF_ZXSTATISTICS_A5C6  // 超载
#define ZXSTATISTICS_A5C7_POS2_ADDR   (ZXSTATISTICS_A5C7_POS1_ADDR+8)  // 三圈
#define ZXSTATISTICS_A5C7_POS3_ADDR   (ZXSTATISTICS_A5C7_POS2_ADDR+8)  // 高限
#define ZXSTATISTICS_A5C7_POS4_ADDR   (ZXSTATISTICS_A5C7_POS3_ADDR+8)  // 总强制
#define ZXSTATISTICS_A5C7_POS5_ADDR   (ZXSTATISTICS_A5C7_POS4_ADDR+8)  // 拆装开关
#define ZXSTATISTICS_A5C7_POS6_ADDR   (ZXSTATISTICS_A5C7_POS5_ADDR+8)  // 变幅起强制
#define ZXSTATISTICS_A5C7_POS7_ADDR   (ZXSTATISTICS_A5C7_POS6_ADDR+8)  // 高限强制
#define ZXSTATISTICS_A5C7_POS8_ADDR   (ZXSTATISTICS_A5C7_POS7_ADDR+8)  // 三圈强制
#define ZXSTATISTICS_A5C7_POS9_ADDR   (ZXSTATISTICS_A5C7_POS8_ADDR+8)  // 风速超限
#define SIZE_OF_ZXSTATISTICS_A5C7       (ZXSTATISTICS_A5C7_POS9_ADDR+8)  // 总字节数(72B)

// 统计数据缓存大小
#define SIZE_OF_ZXSTATISTICS_BUFFER   SIZE_OF_ZXSTATISTICS_A5C7 //(zxstatistics_buffer_a5c7+SIZE_OF_ZXSTATISTICS_A5C7-zxstatistics_buffer_a5c5) 
...
#define ZXVERSION_A505_POS1_ADDR   0  // 力矩限制器
#define ZXVERSION_A505_POS2_ADDR   (ZXVERSION_A505_POS1_ADDR+3)  // 显示器1
#define ZXVERSION_A505_POS3_ADDR   (ZXVERSION_A505_POS2_ADDR+3)  // 显示器底层版本
#define ZXVERSION_A505_POS4_ADDR   (ZXVERSION_A505_POS3_ADDR+3)  // GPS终端
#define ZXVERSION_A505_POS5_ADDR   (ZXVERSION_A505_POS4_ADDR+3)  // 控制器
#define ZXVERSION_A505_POS6_ADDR   (ZXVERSION_A505_POS5_ADDR+3)  // 显示器2
#define ZXVERSION_A505_POS7_ADDR   (ZXVERSION_A505_POS6_ADDR+3)  // 显示器2底层
#define SIZE_OF_ZXVERSION_A505     (ZXVERSION_A505_POS7_ADDR+3)  // 总字节数(21B)

//==TAG-A506 下车系统版本=========================================================
#define zxversion_buffer_a506        (zxversion_buffer+SIZE_OF_ZXVERSION_A505)
#define ZXVERSION_A506_POS1_ADDR   SIZE_OF_ZXVERSION_A505   // 显示器应用层
#define ZXVERSION_A506_POS2_ADDR   (ZXVERSION_A506_POS1_ADDR+3)    // 显示器底层
#define ZXVERSION_A506_POS3_ADDR   (ZXVERSION_A506_POS2_ADDR+3)    // P1应用层
#define ZXVERSION_A506_POS4_ADDR   (ZXVERSION_A506_POS3_ADDR+3)    // P1底层
#define ZXVERSION_A506_POS5_ADDR   (ZXVERSION_A506_POS4_ADDR+3)    // P2应用层
#define ZXVERSION_A506_POS6_ADDR   (ZXVERSION_A506_POS5_ADDR+3)    // P2底层
#define ZXVERSION_A506_POS7_ADDR   (ZXVERSION_A506_POS6_ADDR+3)    // P3应用层
#define ZXVERSION_A506_POS8_ADDR   (ZXVERSION_A506_POS7_ADDR+3)    // P3底层
#define ZXVERSION_A506_POS9_ADDR   (ZXVERSION_A506_POS8_ADDR+3)    // P4应用层
#define ZXVERSION_A506_POS10_ADDR   (ZXVERSION_A506_POS9_ADDR+3)   // P4底层
#define ZXVERSION_A506_POS11_ADDR   (ZXVERSION_A506_POS10_ADDR+3)  // P5应用层
#define ZXVERSION_A506_POS12_ADDR   (ZXVERSION_A506_POS11_ADDR+3)  // P5底层
#define ZXVERSION_A506_POS13_ADDR   (ZXVERSION_A506_POS12_ADDR+3)  // P6应用层
#define ZXVERSION_A506_POS14_ADDR   (ZXVERSION_A506_POS13_ADDR+3)  // P6底层
#define ZXVERSION_A506_POS15_ADDR   (ZXVERSION_A506_POS14_ADDR+3)  // P7应用层
#define ZXVERSION_A506_POS16_ADDR   (ZXVERSION_A506_POS15_ADDR+3)  // P7底层
#define ZXVERSION_A506_POS17_ADDR   (ZXVERSION_A506_POS16_ADDR+3)  // P8应用层
#define ZXVERSION_A506_POS18_ADDR   (ZXVERSION_A506_POS17_ADDR+3)  // P8底层
#define SIZE_OF_ZXVERSION_A506       (ZXVERSION_A506_POS18_ADDR+3)  // 总字节数(54B)

// 版本信息数据缓存大小
#define SIZE_OF_ZXVERSION_BUFFER   SIZE_OF_ZXVERSION_A506 // (zxversion_buffer_a506+SIZE_OF_ZXVERSION_A506-zxversion_buffer_a505) 
...
#define tlv_a505_valid_flag    zxversion_tlv_flag.w.bit0
#define tlv_a506_valid_flag    zxversion_tlv_flag.w.bit1
...
#define tlv_a5c5_valid_flag    zxstatistics_tlv_flag.w.bit0
#define tlv_a5c6_valid_flag    zxstatistics_tlv_flag.w.bit1
#define tlv_a5c7_valid_flag    zxstatistics_tlv_flag.w.bit2
//#define X    zxstatistics_tlv_flag.w.bit3
