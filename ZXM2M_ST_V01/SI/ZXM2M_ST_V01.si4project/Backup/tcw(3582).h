...
//==TAG-A502环境信息(发动机的数据)================================================
#define ZXINFO_A502_ADDR         (ZXINFO_A501_ADDR+SIZE_OF_ZXINFO_A501)  // 起始地址
#define zxinfo_buffer_a502       (zxinfo_buffer+SIZE_OF_ZXINFO_A502)  // 起始地址定义
#define ZXINFO_A502_POS1_ADDR    0                          // 大气压力
#define ZXINFO_A502_POS2_ADDR    (ZXINFO_A502_POS1_ADDR+1)  // 环境温度
#define SIZE_OF_ZXINFO_A502      (ZXINFO_A502_POS2_ADDR+2)  // 总字节数(3B)

//==TAG-A504采集协议信息==========================================================
#define ZXINFO_A504_ADDR         (ZXINFO_A502_ADDR+SIZE_OF_ZXINFO_A502)  // 起始地址
#define zxinfo_buffer_a504       (zxinfo_buffer+SIZE_OF_ZXINFO_A502)  // 起始地址定义
...
//==TAG-3004外部电源电压==========================================================
#define ZXINFO_3004_ADDR         (ZXINFO_A504_ADDR+SIZE_OF_ZXINFO_A504)  // 起始地址
#define zxinfo_buffer_3004       (zxinfo_buffer+ZXINFO_3004_ADDR)  // 起始地址定义
#define ZXINFO_3004_POS1_ADDR    0                          // 外部电源电压
#define SIZE_OF_ZXINFO_3004      (ZXINFO_3004_POS1_ADDR+2)  // 总字节数(3B)

//==TAG-3005终端内置电池电压==========================================================
#define ZXINFO_3005_ADDR         (ZXINFO_3004_ADDR+SIZE_OF_ZXINFO_3004)  // 起始地址
#define zxinfo_buffer_3005       (zxinfo_buffer+ZXINFO_3005_ADDR)  // 起始地址定义
#define ZXINFO_3005_POS1_ADDR    0                          // 内置电池电压
#define SIZE_OF_ZXINFO_3005      (ZXINFO_3005_POS1_ADDR+2)  // 总字节数(3B)

// 车型配置信息数据缓存大小
#define SIZE_OF_ZXINFO_BUFFER  (ZXINFO_3005_ADDR+SIZE_OF_ZXINFO_3005)
...
#define SIZE_OF_ZXDOWN_A5EB (ZXDOWN_A5EB_POS3+18)  // 总字节数(18B)
...
#define tlv_a501_valid_flag    zxinfo_tlv_flag.w.bit0
#define tlv_a502_valid_flag    zxinfo_tlv_flag.w.bit1
#define tlv_a504_valid_flag    zxinfo_tlv_flag.w.bit2
#define tlv_3004_valid_flag    zxinfo_tlv_flag.w.bit3
#define tlv_3005_valid_flag    zxinfo_tlv_flag.w.bit4
