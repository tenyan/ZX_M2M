...
#define SIZE_OF_ZXUP_A5A0         (ZXUP_A5A0_POS28+2) // 总字节数(82B)

//==TAG-A5A1超起工况信息==========================================================
#define zxup_buffer_a5a1       (zxup_buffer+SIZE_OF_ZXUP_A5A0) // 起始地址定义
#define ZXUP_A5A1_ADDR    (ZXUP_A5A0_ADDR+SIZE_OF_ZXUP_A5A0)    // 起始地址
...
#define ZXUP_A5A2_ADDR    (ZXUP_A5A1_ADDR+SIZE_OF_ZXUP_A5A1)    // 起始地址
...
#define ZXUP_A5A5_ADDR    (ZXUP_A5A2_ADDR+SIZE_OF_ZXUP_A5A2)    // 起始地址
...
#define ZXUP_A5A6_ADDR    (ZXUP_A5A5_ADDR+SIZE_OF_ZXUP_A5A5)    // 起始地址
...
#define ZXUP_A5A7_ADDR    (ZXUP_A5A6_ADDR+SIZE_OF_ZXUP_A5A6)    // 起始地址
...
#define ZXUP_A5A8_ADDR    (ZXUP_A5A7_ADDR+SIZE_OF_ZXUP_A5A7)    // 起始地址
...
#define ZXUP_A5A9_ADDR    (ZXUP_A5A8_ADDR+SIZE_OF_ZXUP_A5A8)    // 起始地址
...
#define ZXUP_A5AA_ADDR    (ZXUP_A5A9_ADDR+SIZE_OF_ZXUP_A5A9)    // 起始地址
...
#define ZXUP_A5AB_ADDR    (ZXUP_A5AA_ADDR+SIZE_OF_ZXUP_A5AA)    // 起始地址
...
#define ZXUP_A5AC_ADDR    (ZXUP_A5AB_ADDR+SIZE_OF_ZXUP_A5AB)    // 起始地址
...
#define ZXUP_A5AD_ADDR    (ZXUP_A5AC_ADDR+SIZE_OF_ZXUP_A5AC)    // 起始地址
...
#define ZXUP_A5AE_ADDR    (ZXUP_A5AD_ADDR+SIZE_OF_ZXUP_A5AD)    // 起始地址
...
#define ZXUP_A5AF_ADDR    (ZXUP_A5AE_ADDR+SIZE_OF_ZXUP_A5AE)    // 起始地址
...
#define ZXUP_A5B0_ADDR    (ZXUP_A5AF_ADDR+SIZE_OF_ZXUP_A5AF)    // 起始地址
...
#define ZXUP_A5B1_ADDR    (ZXUP_A5B0_ADDR+SIZE_OF_ZXUP_A5B0)    // 起始地址
...
#define ZXUP_A5B3_ADDR    (ZXUP_A5B2_ADDR+SIZE_OF_ZXUP_A5B2)    // 起始地址
...
#define ZXUP_A5B4_ADDR    (ZXUP_A5B3_ADDR+SIZE_OF_ZXUP_A5B3)    // 起始地址
...
#define ZXUP_A5B5_ADDR    (ZXUP_A5B4_ADDR+SIZE_OF_ZXUP_A5B4)    // 起始地址
...
#define SIZE_OF_ZXUP_A5B5      (ZXUP_A5B5_POS13+1)  // 总字节数(23B)

//==TAG-A5B6主阀3 大吨位==========================================================
#define zxup_buffer_a5b6       (zxup_buffer+SIZE_OF_ZXUP_A5B5)// 起始地址定义
#define ZXUP_A5B6_ADDR    (ZXUP_A5B5_ADDR+SIZE_OF_ZXUP_A5B5)    // 起始地址
...
#define ZXUP_A5B7_ADDR    (ZXUP_A5B6_ADDR+SIZE_OF_ZXUP_A5B6)    // 起始地址
...
#define ZXUP_A5B8_ADDR    (ZXUP_A5B7_ADDR+SIZE_OF_ZXUP_A5B7)    // 起始地址
...
#define ZXUP_A5B9_ADDR    (ZXUP_A5B8_ADDR+SIZE_OF_ZXUP_A5B8)    // 起始地址
...
#define ZXUP_A5BA_ADDR    (ZXUP_A5B9_ADDR+SIZE_OF_ZXUP_A5B9)    // 起始地址
...
#define ZXUP_A5BB_ADDR    (ZXUP_A5BA_ADDR+SIZE_OF_ZXUP_A5BA)   // 起始地址
...
#define ZXUP_A5BC_ADDR    (ZXUP_A5BB_ADDR+SIZE_OF_ZXUP_A5BB)    // 起始地址
...
#define ZXUP_A5BD_ADDR    (ZXUP_A5BC_ADDR+SIZE_OF_ZXUP_A5BC)    // 起始地址
...
#define ZXUP_A5BE_ADDR    (ZXUP_A5BD_ADDR+SIZE_OF_ZXUP_A5BD)    // 起始地址
...
#define ZXUP_A5BF_ADDR    (ZXUP_A5BE_ADDR+SIZE_OF_ZXUP_A5BE)    // 起始地址
...
#define ZXUP_A5C0_ADDR    (ZXUP_A5BF_ADDR+SIZE_OF_ZXUP_A5BF)    // 起始地址
...
#define ZXUP_A5C1_ADDR    (ZXUP_A5C0_ADDR+SIZE_OF_ZXUP_A5C0)    // 起始地址
...
#define ZXUP_A5C2_ADDR    (ZXUP_A5C1_ADDR+SIZE_OF_ZXUP_A5C1)    // 起始地址
...
#define ZXUP_A5C3_ADDR    (ZXUP_A5C2_ADDR+SIZE_OF_ZXUP_A5C2)    // 起始地址
...
#define ZXUP_A5C4_ADDR    (ZXUP_A5C3_ADDR+SIZE_OF_ZXUP_A5C3)    // 起始地址
...
#define ZXUP_A5C8_ADDR    (ZXUP_A5C4_ADDR+SIZE_OF_ZXUP_A5C4)    // 起始地址
...
#define ZXUP_A5C9_ADDR    (ZXUP_A5C8_ADDR+SIZE_OF_ZXUP_A5C8)    // 起始地址
...
#define ZXDOWN_A5EB_POS1    0                          // 胎压#1-6
#define ZXDOWN_A5EB_POS2    (ZXDOWN_A5EB_POS1+6)  // 胎压#7-12
#define ZXDOWN_A5EB_POS3    (ZXDOWN_A5EB_POS2+6)  // 胎压#13-18
#define SIZE_OF_ZXDOWN_A5EB      (ZXDOWN_A5EB_POS3+6)  // 总字节数(18B)
...
#define ZXENGINE_A5EF_ADDR    0                            // 起始地址
...
#define SIZE_OF_ZXENGINE_A5EF      (ZXENGINE_A5EF_POS23+1)  // 总字节数(37B)
